...
<body>
    ...
    <div class="container mt-5">
        <a href="student.php" class="btn btn-dark">Go Back</a><br/><br/>
        <form method="post" class="shadow p-3 mt-5 form-w" action="req/student-edit.php">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" value="<?=$student['email_address'] ?>" 
                        name="email_address">
            </div>
            ...
            <div class="mb-3">
                ...
                <?php if($student['gender'] == 'Male') echo 'checked'; ?> name="gender"> Male
                &nbsp; &nbsp; &nbsp; &nbsp;
                <input type="radio" value="Female"
                <?php if($student['gender'] == 'Female') echo 'checked'; ?> name="gender"> Female
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" value="<?=$student['parent_fname'] ?>" 
                        name="parent_fname">
            </div>

            <div class="mb-3">
                <label class="form-label">Parent last name</label>
                <input type="text" class="form-control" value="<?=$student['parent_lname'] ?>" 
                        name="parent_lname">
            </div>
        ...
        <form method="post" class="shadow p-3 my-5 form-w"
             action="req/student-change.php" id="change_password">
        ...
        <div class="mb-3">
                ...
                <div class="input-group mb-3">
                    ...
                    <button class="btn btn-secondary" id="gBtn" onclick="makePass(5)">Random</button>
                </div>
            </div>
