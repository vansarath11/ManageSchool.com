...
<body>
    ...
    <div class="container mt-5">
        <a href="section.php" class="btn btn-dark">Go Back</a><br/><br/>
        <form method="post" class="shadow p-3 mt-5 form-w" action="req/section-edit.php">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" value="<?= $section['section'] ?>" 
                        name="section">
            </div>
            <input type="text" class="form-control" value="<?= $section['section_id'] ?>" 
